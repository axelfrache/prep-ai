...
func buildCreatePrompt(req domain.CreateRequest) string {
	...
	b.WriteString(optionalLine("Available materials", "Available materials: use the default material rules from the prompt.", req.AvailableMaterials))
...
`)
	...
	b.WriteString("\nAvailable materials:\n")
	b.WriteString(orDefault(req.AvailableMaterials, "Use the default material rules from the prompt."))
