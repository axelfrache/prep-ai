...
const translations = {
  fr: {
    ...
    'programmation.listTitle': 'Mes programmations',
    'programmation.viewList': 'Voir mes programmations',
    'programmation.emptyTitle': 'Aucune programmation pour le moment',
    'programmation.emptyDescription': 'Créez votre première programmation pour la retrouver ici.',
    'programmation.deleteTitle': 'Supprimer cette programmation ?',
    'programmation.deleteDescription':
      'Cette action est définitive. La programmation ne sera plus disponible dans votre historique.',
    'programmation.deleteSuccess': 'Programmation supprimée.',
    'programmation.deleteError': 'Suppression impossible.',
    'programmation.loadError': 'Chargement impossible.',
    'programmation.openError': 'Ouverture impossible.',
  ...
  en: {
    ...
    'programmation.listTitle': 'My yearly plans',
    'programmation.viewList': 'View my yearly plans',
    'programmation.emptyTitle': 'No yearly plans yet',
    'programmation.emptyDescription': 'Create your first yearly plan to find it here.',
    'programmation.deleteTitle': 'Delete this yearly plan?',
    'programmation.deleteDescription':
      'This action is permanent. The yearly plan will no longer be available in your history.',
    'programmation.deleteSuccess': 'Yearly plan deleted.',
    'programmation.deleteError': 'Unable to delete.',
    'programmation.loadError': 'Unable to load.',
    'programmation.openError': 'Unable to open.',
